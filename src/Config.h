...
#define JETSON_JSON_BUFFER_SIZE     512     // Max JSON message size
...
#define GPS_QUEUE_BATCH_SIZE     8                // entries per flush
#define GPS_QUEUE_FLUSH_INTERVAL 500              // ms between flushes
